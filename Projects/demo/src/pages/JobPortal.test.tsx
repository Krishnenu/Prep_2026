...
describe('JobPortal Component', () => {
    ...
    describe('Error Handling', () => {
        it('should handle error when fetching individual jobs fails', async () => {
            ...
            (globalThis.fetch as jest.Mock).mockRejectedValueOnce(new Error('Failed to fetch job'));
    ...
    describe('Edge Cases', () => {
        ...
        it('should not fetch jobs if jobIds is empty', async () => {
            (globalThis.fetch as jest.Mock).mockResolvedValueOnce({
                json: async () => [],
            });
            ...
            await waitFor(() => {
                expect(globalThis.fetch).toHaveBeenCalledTimes(1); // Only the jobIds fetch
            });
        });
    });
});
